          ...
          <Col span={6}>
            <Card>
              <Statistic
                ...
                suffix="л"
                precision={2}
                valueStyle={getFuelBalanceValueStyle(metrics.totalBalance)}
              />
            </Card>
          </Col>
          <Col span={6}>
            <Card>
              <Statistic
                ...
                suffix="л"
                precision={2}
                valueStyle={getBaseFuelRemainderValueStyle(metrics.baseBalance)}
              />
            </Card>
          </Col>
          <Col span={6}>
            <Card>
              <Statistic
                ...
                suffix="л"
                precision={2}
                valueStyle={getFuelBalanceValueStyle(metrics.bunkerBalance)}
              />
            </Card>
          </Col>
          <Col span={6}>
